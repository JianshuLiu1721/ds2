...
public class Query5Enhanced {

    private static final Logger logger  = LoggerFactory.getLogger(Query5Enhanced.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        afterWindow.transform("DummyLatencySink", objectTypeInfo, new DummyLatencyCountingSink<>(logger))
                .setParallelism(params.getInt("p-window", 1));
        env.execute("Nexmark Query5 Enhanced");
    }
    ...
    private static final class CountBidsWithLatency implements AggregateFunction<BidWithTimestamp, CountBidsWithLatency.Accumulator, LatencyTrackedTuple> {
        ...
        private static class Accumulator {
            long auction = 0L;
            long count = 0L;
            long minSourceEmitTime = Long.MAX_VALUE;
        ...
        public Accumulator add(BidWithTimestamp value, Accumulator accumulator) {
            ...
            accumulator.count += 1;
            // Track the earliest source emit time and latest processing times
            accumulator.minSourceEmitTime = Math.min(accumulator.minSourceEmitTime, value.sourceEmitTime);
        ...
        public LatencyTrackedTuple getResult(Accumulator accumulator) {
            ...
            result.setSourceEmitTime(accumulator.minSourceEmitTime);
        ...
        public Accumulator merge(Accumulator a, Accumulator b) {
            ...
            merged.minSourceEmitTime = Math.min(a.minSourceEmitTime, b.minSourceEmitTime);
